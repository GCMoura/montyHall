...
export default {
    ...
    data: function() { //quando se trabalha com componente VUE a propriedade data é uma função
        //preciso saber se a porta está fechada ou não
        //e se tem o presente ou não.
        //preciso guardar dois estados da porta:
